<?php
	...
	class Db{
		...
		public function __construct(){
			...
			$this->connect($config['user'], $config['pass'], $config['name'], $config['host']);
		}
		...
		public function qf_assoc($query, $return = true){
			$this->setQuery($query);
			$this->getSql();
			$this->getAssoc();
		...
		public function qf_array($query, $return = true){
			$this->setQuery($query);
			$this->getSql();
			$this->getArray();
			if($return) return $this->returnData();
